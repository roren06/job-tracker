...
exports.DEMO_EMAIL = void 0;
exports.seedDemoApplications = seedDemoApplications;
const prisma_1 = require("../prisma");
exports.DEMO_EMAIL = "demo@jobtracker.app";
...
async function seedDemoApplications(userId) {
    await prisma_1.prisma.application.deleteMany({ where: { userId } });
